...
| `renderEmpty` | `func` | `() => `[`React.PropTypes.element`](https://facebook.github.io/react/docs/typechecking-with-proptypes.html#react.proptypes) | If your data is empty (e.g. `null`, `[]`, `{}`) and this prop is defined, then the result of this function will be rendered instead. For example, you can use the [`EmptyListView` component](#emptylistview) for this. |
